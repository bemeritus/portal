...
export const en = {
  translation: {
    ...
    users: {
      ...
      sectionProjectsLead: "Can manage boards (lead)",
    ...
    projects: {
      ...
      cardDescription: "Description (markdown)",
      cardDescriptionPlaceholder: "Details, acceptance criteria…",
      assignee: "Assignee",
